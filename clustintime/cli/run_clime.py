...
def _get_parser():
    ...
    optional.add_argument(
        ...
        dest="timings_file",
        type=str,
        help="The name or fullpath to the file(s) containing the onset" "of the tasks",
        required=False,
        nargs="*",
        default=None,
    )
    ...
    optional.add_argument(
        ...
        dest="save_maps",
        action="store_true",
        help="Save the generated maps. " "Default is not to save",
        required=False,
        default=True,
    )
    optional.add_argument(
        ...
        dest="consensus",
        action="store_true",
        help="Use consensus in the clustering algorithm." "Default is not to use",
        required=False,
        default=False,
    )
    optional.add_argument(
