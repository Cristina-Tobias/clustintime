...
# -*- coding: utf-8 -*-
#
# clustintime documentation build configuration file, created by
# sphinx-quickstart
#
...
version = clustintime.__version__
# The full version, including alpha/beta/rc tags.
release = clustintime.__version__
...
htmlhelp_basename = "clustintimedoc"

# The following is used by sphinx.ext.linkcode to provide links to github
linkcode_resolve = make_linkcode_resolve(
    "clustintime",
    "https://github.com/me-ica/clustintime/blob/{revision}/{package}/{path}#L{lineno}",
)
